    ...
    public static function for(BlockType $type): array
    {
        return match ($type) {
            ...
            BlockType::Table => [
                ...
                'showHeader' => ['type' => 'bool', 'default' => true],
                ...
                'marginTopMm' => ['type' => 'float', 'default' => 0.0, 'min' => 0.0, 'max' => 100.0],
                'marginRightMm' => ['type' => 'float', 'default' => 0.0, 'min' => 0.0, 'max' => 100.0],
                'marginBottomMm' => ['type' => 'float', 'default' => 0.0, 'min' => 0.0, 'max' => 100.0],
                'marginLeftMm' => ['type' => 'float', 'default' => 0.0, 'min' => 0.0, 'max' => 100.0],
            ],
            BlockType::ListBlock => [
